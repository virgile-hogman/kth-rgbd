...
\centering$
 \begin{array}{c}
 \subfloat[]{\label{fig:lc_sw_1}\includegraphics[width=0.7\textwidth]{figures/graph_lc_sw1}} \\
 \subfloat[]{\label{fig:lc_sw_2}\includegraphics[width=0.7\textwidth]{figures/graph_lc_sw2}}
 \end{array}$
...
\centering$
\begin{array}{c}
\subfloat[]{\label{fig:room1_1}\includegraphics[width=0.7\textwidth]{pictures/room1_initial}} \\
\subfloat[]{\label{fig:room1_2}\includegraphics[width=0.7\textwidth]{pictures/room1_optimized}}
 \end{array}$
