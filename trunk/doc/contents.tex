...
\centering$
 ...
 \end{array}$
\caption{Estimation of the poses - \protect\subref{fig:poses_4r_1_1} From standard odometry, raw data. Note the drift. \protect\subref{fig:poses_4r_1_2} With this system, initial graph. Note the similarity of the angular drift with the standard odometry, while the two sources are different. }
\end{figure}
...
\centering$
 ...
 \end{array}$
\caption{Estimation of the poses - \protect\subref{fig:poses_4r_2_1} With the initial graph.  \protect\subref{fig:poses_4r_2_2} With the optimized graph. }
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{figures/cvap_7th_4r_optimized}
\caption{Trajectory overlayed on the reference map of the 7th floor}
\end{figure}
