...
\caption{Trajectory overlayed on the reference map of the 7th floor, \protect\subref{fig:mappath_1} with SIFT features, \protect\subref{fig:mappath_2} with SURF features. In both cases, the drift is noticeable, but the results are relatively close.}
\label{fig:plan_cvap}
\end{figure}
...
For this map, the dataset "Lab3" provided by the University of Birminghman was used. No particular issues were ecountered.
