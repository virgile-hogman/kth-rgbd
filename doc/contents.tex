...
Several libraries exist. For this work is used the library developed by Rob Hess~\cite{hess_sift}.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{figures/bad_inliers1}
...
\centering$
\begin{array}{cccc}
\includegraphics[width=0.3\textwidth]{figures/bad_transform1} &
\includegraphics[width=0.3\textwidth]{figures/bad_transform2} &
\includegraphics[width=0.3\textwidth]{figures/bad_transform3}
\end{array}$
...
\centering$
\begin{array}{cc}
\includegraphics[width=0.4\textwidth]{figures/graph4_base} &
\includegraphics[width=0.4\textwidth]{figures/graph4_initial_guess}
\end{array}$
...
\begin{array}{cc}
\includegraphics[width=0.4\textwidth]{figures/graph4_initial_guess} &
\includegraphics[width=0.4\textwidth]{figures/graph4_optimized}
\end{array}$
...
Of course, this method is not optimal, as this leads to duplicate points, and does not take variances of illumination into account. Another solution would be to use some surfels~\cite{Intel_RGBD_2010} but this would require some intensive processing and is out of the scope of this work.
